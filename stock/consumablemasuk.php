...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Barang Masuk Consumable</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['filter_tgl'])) {
                                                ...
                                                if ($mulai != null || $selesai != null) {
                                                    ...
                                                    $cbarangmasuk = mysqli_query($conn, "SELECT * from sbarangcmasuk pa, stockc sa where sa.idx=pa.idx AND tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by tanggal ASC");
                                                } else {
                                                    $cbarangmasuk = mysqli_query($conn, "SELECT * from sbarangcmasuk pa, stockc sa where sa.idx=pa.idx order by tanggal ASC");
                                            ...
                                            $no = 1;
                                            while ($p = mysqli_fetch_array($cbarangmasuk)) {
                                                $idb = $p['idx'];
                                                $id = $p['id'];
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="del_bcmasuk_act.php" method="post">
                                ...
                                <br>
                                <a href="exportbcmasuk.php" target="_blank" class="btn btn-dark">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Stock Masuk Consumable</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_bcmasuk_act.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kodebarang" class="custom-select form-control"
                                ...
                                <?php
                                $deta = mysqli_query($conn, "select * from stockc order by kodebarang ASC");
                        ...
                        <div class="form-group">
                            ...
                            <input name="masuk" type="text" class="form-control" placeholder="Jumlah">
                        </div>
                        <div class="form-group">
                            <label>No PO</label>
                            <input name="nopo" type="text" class="form-control" placeholder="Nomor PO">
                        </div>
                        <div class="form-group">
        ...
        function fetchStock(selectedKodeBarang) {
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    var masuk = parseInt(data.masuk); // Get the value of "masuk" input
                    var keluar = parseInt(data.keluar);
            ...
            xhttp.open("GET", "get_stock.php?kodebarang=" + encodeURIComponent(selectedKodeBarang), true);
            xhttp.send();
        }
    </script>
