                ...
                <tbody>
                    ...
                    if (isset($_POST['filter_tgl'])) {
                        ...
                        if ($mulai != null || $selesai != null) {
                            ...
                            $barangckeluar = mysqli_query($conn, "SELECT * from sbarangmkeluar pa, stockm sa where sa.idx=pa.idz AND tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by tanggal ASC");
                        } else {
                            $barangckeluar = mysqli_query($conn, "SELECT * from sbarangmkeluar pa, stockm sa where sa.idx=pa.idz order by tanggal ASC");
