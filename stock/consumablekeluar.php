...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Barang keluar Consumable</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4>Daftar Keluar Stock Consumable</h4>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['filter_tgl'])) {
                                                ...
                                                if ($mulai != null || $selesai != null) {
                                                    ...
                                                    $cbarangkeluar = mysqli_query($conn, "SELECT * from sbarangckeluar sc, stockc sk where sk.idx=sc.idx AND tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by tanggal ASC");
                                                } else {
                                                    $cbarangkeluar = mysqli_query($conn, "SELECT * from sbarangckeluar sc, stockc sk where sk.idx=sc.idx order by tanggal ASC");
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="del_bckeluar_act.php" method="post">
                                ...
                                <br>
                                <a href="exportbckeluar.php" target="_blank" class="btn btn-dark">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Stock Keluar Consumable</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_bckeluar_act.php" method="post">
