...
<head>
    ...
    <title>Export Data Consumable</title>
...
<body>
    <div class="container">
        <br>
        <h2>Daftar Keluar Consumable</h2>
                ...
                <tbody>
                    ...
                    if (isset($_POST['filter_tgl'])) {
                        ...
                        if ($mulai != null || $selesai != null) {
                            ...
                            $barangckeluar = mysqli_query($conn, "SELECT * from sbarangckeluar pa, stockc sa where sa.idx=pa.idx AND tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by tanggal ASC");
                        } else {
                            $barangckeluar = mysqli_query($conn, "SELECT * from sbarangckeluar pa, stockc sa where sa.idx=pa.idx order by tanggal ASC");
