...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "update stockm set kodebarang='$kodebarang', namabarang='$namabarang', stockawal='$stockawal', satuan='$satuan' where idx='$idx'");
    //cek apakah berhasil
    if ($updatedata) {
...
if (isset($_POST['hapus'])) {
    ...
    $delete = mysqli_query($conn, "delete from stockm where idx='$idx'");
...
<body>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="stockmaterial.php"><i class="ti-package"></i> Stock Consumable</a>
                                    </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Stock Material</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <a href="exportsmaterial.php" target="_blank" class="btn btn-dark">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Masukkan Stock Material</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_brgm_act.php" method="post">
