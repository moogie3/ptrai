...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Barang Masuk Material</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4>Daftar Masuk Stock Material</h4>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['filter_tgl'])) {
                                                ...
                                                if ($mulai != null || $selesai != null) {
                                                    ...
                                                    $cbarangmasuk = mysqli_query($conn, "SELECT * from sbarangmmasuk pa, stockm sa where sa.idx=pa.idx AND tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) order by tanggal ASC");
                                                } else {
                                                    $cbarangmasuk = mysqli_query($conn, "SELECT * from sbarangmmasuk pa, stockm sa where sa.idx=pa.idx order by tanggal ASC");
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="del_bmmasuk_act.php" method="post">
                                ...
                                <br>
                                <a href="exportbmmasuk.php" target="_blank" class="btn btn-dark">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Stock Masuk Material</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_bmmasuk_act.php" method="post">
